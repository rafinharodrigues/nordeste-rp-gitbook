...
- **Reféns não são permitidos** em ações de venda de drogas.
- Em caso de Coop Baiting após os 05 minutos de fuga, **pena máxima** poderá ser gerada para os bandidos caso os mesmos percam.

### Caso de fuga para dentro de mar, lago ou algo do tipo, a polícia estará permitida em realizar a neutralização do(s) bandido(s).
