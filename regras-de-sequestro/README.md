...
• É permitido o sequestro de até 3 vítimas simultaneamente, sendo expressamente proibido ultrapassar esse limite.&#x20;

• Fica estritamente proibido realizar sequestros em áreas safe, conforme definido pelas zonas protegidas da cidade.&#x20;

• Durante todo o período do sequestro (abordagem, transporte e negociação), é obrigatório o uso de algemas nos sequestrados.&#x20;

• A negociação deve ser conduzida exclusivamente com a polícia ou com a facção do envolvido, sendo proibido qualquer tipo de negociação paralela.&#x20;

• É permitido retirar do sequestrado apenas armas, munições, rádio e celular, exclusivamente com o objetivo de cortar a comunicação e reduzir riscos à vida.&#x20;
...
• É proibido enrolar ou atrasar a negociação propositalmente, tanto por parte dos sequestradores quanto da polícia ou facção.&#x20;
...
• Não é permitido forçar situações irreais, anti-RP ou que quebrem a imersão.&#x20;

• É proibido executar o refém sem motivo plausível. A execução só será permitida em casos de:&#x20;

* &#x20;Quebra de acordo durante a negociação.&#x20;
* &#x20;Reação direta da polícia.
* &#x20;Risco real e imediato à vida dos sequestradores.&#x20;

&#x20;É proibido utilizar metagaming ou qualquer comunicação externa para benefício na ação.&#x20;
...
* &#x20;Jogar o refém de veículos em movimento.
...
* O refém for liberado&#x20;
* Refém vier a óbito&#x20;
* Todos os envolvidos forem neutralizados
...
• A staff se reserva ao direito de intervir, ajustar valores, encerrar ações ou aplicar punições, caso necessário para manter o equilíbrio da cidade.
